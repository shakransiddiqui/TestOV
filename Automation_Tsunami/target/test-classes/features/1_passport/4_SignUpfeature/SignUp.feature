...
Feature: SignUp_Feature
  ...
  @validate_signup_without_accepting_terms @passport-neg
  ...
  @validate_unsuccessful_signup_with_invalid_email_format @passport-neg
  ...
  @validate_unsuccessful_signup_with_existing_email @passport-neg
  ...
  @validate_unsuccessful_signup_with_missing_email_required_field @passport-neg
  ...
  @validate_unsuccessful_signup_with_missing_any_other_required_fields @passport-neg
  ...
  @validate_unsuccessful_signup_with_missing_password_required_fields @passport-neg
  ...
  @validate_unsuccessful_signup_with_invalid_password_required_field @passport-neg
  ...
  @Validate_Successful_Account_Creation @passport-pos
  ...
  @validate_Post_Sign_Up_Role_Selection @passport-pos
  ...
  @validate_Startup_Information_Initial_Setup @passport-pos
