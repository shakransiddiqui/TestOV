...
public class Login_StepD extends CommonMethods {
	...
	public void pass_digit_numeric_user_id_on_user_id_field_and_immidiately_clear_it(Integer count, Integer userID_fromFeature) {

		String inserted_fieldValue = String.valueOf(userID_fromFeature);
		String fieldName_UserID = "UserID";

		String actualFieldValueinTheUI =  hmpage_pom.passFieldValue(inserted_fieldValue, fieldName_UserID);
		...
		String actualFieldValueinTheUI_afterClear = hmpage_pom.clearField(fieldName_UserID);
	...
	public void i_enter_and_immidiately_clear_the_following_user_i_ds(DataTable dataTable) {
	...
	public void i_try_with_following_credentials(DataTable dataTable) {
		...
		for(Map<String, String> row:credentials_List_fromFeature) {
			...
			//Getting values to insert into the Fields:
			String userID_value = row.get("UserID");
			String password_value = row.get("Password");

			//Passing values to the Fields:
			String actual_User_FieldValueinTheUI =  hmpage_pom.passFieldValue(userID_value, "UserID");
			String actual_Pass_FieldValueinTheUI =  hmpage_pom.passFieldValue(password_value, "Password");

			//Assertion after clearing UserID field:
			...
			//Assertion after clearing Password field:
